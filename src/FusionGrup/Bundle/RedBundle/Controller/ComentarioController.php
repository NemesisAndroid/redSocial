...
use FusionGrup\Bundle\RedBundle\Entity\Comentario;
use FusionGrup\Bundle\RedBundle\Form\ComentarioType;
...
class ComentarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FusionGrupRedBundle:Comentario')->findAll();
     ...
     * @Method("POST")
     * @Template("FusionGrupRedBundle:Comentario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FusionGrupRedBundle:Comentario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FusionGrupRedBundle:Comentario:edit.html.twig")
     */
