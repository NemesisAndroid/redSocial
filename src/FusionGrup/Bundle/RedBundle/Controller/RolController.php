...
use FusionGrup\Bundle\RedBundle\Form\RolType;
...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FusionGrupRedBundle:Rol')->findAll();
     ...
     * @Method("POST")
     * @Template("FusionGrupRedBundle:Rol:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FusionGrupRedBundle:Rol')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FusionGrupRedBundle:Rol:edit.html.twig")
     */
