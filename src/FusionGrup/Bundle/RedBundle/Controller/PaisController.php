...
use FusionGrup\Bundle\RedBundle\Entity\Pais;
use FusionGrup\Bundle\RedBundle\Form\PaisType;
...
class PaisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FusionGrupRedBundle:Pais')->findAll();
     ...
     * @Method("POST")
     * @Template("FusionGrupRedBundle:Pais:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FusionGrupRedBundle:Pais')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FusionGrupRedBundle:Pais:edit.html.twig")
     */
